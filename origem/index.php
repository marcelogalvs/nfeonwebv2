...
if(isset($_POST['btnExcluir'])){
    $query=mysqli_query($conecta, "DELETE FROM origem WHERE pkId = " . $_POST['txtCodigo']) or die(mysql_error());
    if($query){
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Origem Produtos</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Origem Produtos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Arquivo de Origem de Produtos</h4>
                                <h6 class="card-subtitle">Cadastre novas <code>Origem de Produtos </code> ou altere as informações de uma origem de produto <code>cadastrado</code>.</h6>
                                    ...
                                    <tbody>
                                        <?php
                                            if(isset($_POST['txtBusca'])){
                                                $busca=mysqli_query($conecta, "SELECT * FROM origem WHERE descricao LIKE '%". $_POST['txtBusca'] ."%' ORDER BY pkId");
                                            } else {
                                                $busca=mysqli_query($conecta, "SELECT * FROM origem ORDER BY pkId");
                                            }
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLabel">Confirma exclusão da Origem?</h3>
                        ...
                        <div class="modal-body">
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">Descrição CFOP:</label>
