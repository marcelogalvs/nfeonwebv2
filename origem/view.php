...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "UPDATE origem SET descricao = '" . strtoupper(trim($_POST["txtNome"])) . "' WHERE pkId = " . base64_decode($_GET['ref']));
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href=".">Origem Produtos</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <?php
                                $query=mysqli_query($conecta, "SELECT * FROM origem  WHERE pkId=".base64_decode($_GET['ref']));
                                ...
                                <div class="form-body">
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label class="control-label">Origem dos Produtos</label>
