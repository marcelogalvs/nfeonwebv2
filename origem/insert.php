...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "INSERT INTO origem (descricao) VALUES ('" . strtoupper(trim($_POST["txtNome"])) . "')");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href=".">Origem Produto</a></li>
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtNome" class="form-control" placeholder="Ex: NACIONAL, EXCETO AS INDICADAS NOS CODIGOS 3 A 5" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
