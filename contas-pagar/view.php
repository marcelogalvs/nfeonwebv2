...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "UPDATE contas_pagar SET 
    nome = '" . (trim($_POST["txtNome"])) . "' , 
    valor = '" . (trim($_POST["txtValor"])) . "' , 
    vencimento = '" . $dataVencimento . "', 
    baixa = '" . $databaixa . "' , 
    observacoes = '" . (trim($_POST['txtOBS'])) . "',
    status = 'BAIXADO'
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Alteração/Baixa</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-info">
                                <h6 class="mb-0 text-white">Alteração de Cadastro / Baixa</h6>
                            </div>
                            
                            <form method="post" name="frmCadastro">
                                
                                <?php
                                    $query = mysqli_query($conecta, "SELECT * FROM contas_pagar WHERE pkId=".base64_decode($_GET['ref'])) or die(mysql_error());
                                        ...
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtVencimento" class="form-control date-inputmask" id="date-mask" value="<?php echo date('d/m/Y', strtotime($result['vencimento'])) ?>">
                                                </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtValor" class="form-control" placeholder="Ex: 100,00"  onblur="formataNumero(this)" value="<?php echo $result['valor'] ?>">
                                                </div>
                                            </div>
                                            <script type="text/javascript">
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <?php if($result['baixa']!='0000-00-00'){ ?>
                                                        <input type="text" name="txtBaixa" class="form-control date-inputmask" id="date-mask" value="<?php echo date('d/m/Y', strtotime($result['baixa'])) ?>">
                                                    <?php } else { ?>
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="txtOBS" class="form-control" rows="5"  value="<?php echo $result['observacoes'] ?>" placeholder="Ex: Cheque emitido numero 1020 Banco do Brasil"></textarea>
                                                </div>
                                            </div>
