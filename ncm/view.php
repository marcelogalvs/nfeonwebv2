...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "UPDATE ncm SET descricao = '" . strtoupper(trim($_POST["txtNome"])) . "' WHERE pkId = " . base64_decode($_GET['ref']));
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <?php
                                $query=mysqli_query($conecta, "SELECT * FROM ncm WHERE pkId=".base64_decode($_GET['ref']));
