...
if(isset($_POST['btnExcluir'])){
    $query=mysqli_query($conecta, "DELETE FROM ncm WHERE pkId = " . $_POST['txtCodigo']) or die(mysql_error());
    if($query){
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Arquivo de NCM's</h4>
                                <h6 class="card-subtitle">Cadastre novos <code>NCM </code> ou altere as informações de um NCM <code>cadastrado</code>.</h6>
                                    ...
                                    <tbody>
                                        <?php
                                            if(isset($_POST['txtBusca'])){
                                                $busca=mysqli_query($conecta, "SELECT * FROM ncm WHERE descricao LIKE '%". $_POST['txtBusca'] ."%' ORDER BY pkId");
                                            } else {
                                                $busca=mysqli_query($conecta, "SELECT * FROM ncm ORDER BY pkId");
                                            }
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLabel">Confirma exclusão do NCM?</h3>
                        ...
                        <div class="modal-body">
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">Descrição NCM:</label>
