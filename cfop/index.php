...
if(isset($_POST['btnExcluir'])){
    $query=mysqli_query($conecta, "DELETE FROM cfop WHERE pkId = " . $_POST['txtCodigo']) or die(mysql_error());
    if($query){
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">CFOP's</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">CFOP's</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Arquivo de CFOP's</h4>
                                <h6 class="card-subtitle">Cadastre novos <code>CFOP </code> ou altere as informações de um CFOP <code>cadastrado</code>.</h6>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Descrição CFOP</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            if(isset($_POST['txtBusca'])){
                                                $busca=mysqli_query($conecta, "SELECT * FROM cfop WHERE descricao LIKE '%". $_POST['txtBusca'] ."%' ORDER BY pkId");
                                            } else {
                                                $busca=mysqli_query($conecta, "SELECT * FROM cfop ORDER BY pkId");
                                            }
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLabel">Confirma exclusão do CFOP?</h3>
