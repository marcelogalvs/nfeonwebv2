...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "INSERT INTO cfop (pkId , descricao) VALUES ('" . (trim($_POST["txtCodigo"])) . "', '" . strtoupper(trim($_POST["txtNome"])) . "')");
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtCodigo" class="form-control" placeholder="Ex: 5102" autofocus required>
                                                </div>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label class="control-label">Descrição CFOP</label>
                                                    <input type="text" name="txtNome" class="form-control" placeholder="Ex: Venda de mercadoria adquirida ou recebida de terceiros" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
