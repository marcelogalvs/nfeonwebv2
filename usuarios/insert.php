...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "INSERT INTO usuarios (nome , login , senha, nivelacesso, telefone, email) VALUES ('" . (trim($_POST["txtNome"])) . "' , '" . (trim($_POST["txtLogin"])) . "' , '" . (sha1(trim($_POST["txtSenha"]))) . "', '" . (trim($_POST['txtAcesso'])) . "' , '" . (trim($_POST["txtTelefone"])) . "' , '" . (trim($_POST["txtEmail"])) . "')");
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-info">
                                <h6 class="mb-0 text-white">Novo Cadastro <i style="float:right" class="fa fa-user"></i> </h6>
                            </div>
                            <form method="post">
                                <div class="form-body">
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtNome" class="form-control" placeholder="Ex: Marcelo Galvão" autofocus>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="txtTelefone" class="form-control phone-inputmask" id="phone-mask" placeholder="Digite seu Telefone">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Email</label>
                                                    <input type="text" name="txtEmail" class="form-control form-control-danger" placeholder="Ex: marcelo.galvao@r2msolucoes.com.br">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtLogin" class="form-control" placeholder="Informe seu login">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Senha</label>
                                                    <input type="text" name="txtSenha" class="form-control" placeholder="Informe sua senha">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control custom-select" name="txtAcesso" data-placeholder="Selecione" >
                                                        <option value=""></option>
