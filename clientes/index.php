...
if(isset($_POST['btnExcluir'])){
    $query=mysqli_query($conecta, "UPDATE clientes SET status='INATIVO' WHERE pkId = " . $_POST['txtCodigo']) or die(mysql_error());
    if($query){
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Cadastre novos <code>Clientes </code> ou altere as informações de um Cliente <code>cadastrado</code>.</h6>
                                    ...
                                    <tbody>
                                        <?php
                                            if(isset($_POST['txtBusca'])){
                                                $busca=mysqli_query($conecta, "SELECT * FROM clientes WHERE razaoSocial LIKE '%". $_POST['txtBusca'] ."%' ORDER BY pkId");
                                            } else {
                                                $busca=mysqli_query($conecta, "SELECT * FROM clientes ORDER BY pkId");
                                            }
