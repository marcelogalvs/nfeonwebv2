...
if(isset($_POST['btnExcluir'])){
    $query=mysqli_query($conecta, "DELETE FROM emitente WHERE pkId = " . $_POST['txtCodigo']) or die(mysql_error());
    if($query){
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Emitente</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Arquivo de Emitente</h4>
                                <h6 class="card-subtitle">Cadastre novo <code>Emitente </code> ou altere as informações de um Emitente <code>cadastrado</code>.</h6>
                                    ...
                                    <tbody>
                                        <?php
                                            if(isset($_POST['txtBusca'])){
                                                $busca=mysqli_query($conecta, "SELECT * FROM emitente WHERE razaoSocial LIKE '%". $_POST['txtBusca'] ."%' ORDER BY pkId");
                                            } else {
                                                $busca=mysqli_query($conecta, "SELECT * FROM emitente ORDER BY pkId");
                                            }
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo $result['pkId'] ?>" data-whatevernome="<?php echo $result['razaoSocial'] ?>" title="Excluir"><i class="fas fa-eraser"></i></button>
                                            </td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLabel">Confirma exclusão do Emitente?</h3>
                        ...
                        <div class="modal-body">
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">Nome do Emitente:</label>
