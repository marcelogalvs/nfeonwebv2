...
if(isset($_POST['btnIncluir'])){
    ...
    $query = mysqli_query($conecta, "INSERT INTO orcamentos_itens 
    (fkIdOrcamento, fkIdProduto, precoVenda, quantidade) VALUES (
    ...
    if($query){
        ...
        $atualizaTotal = mysqli_query($conecta, "UPDATE orcamentos SET subTotal = (SELECT SUM(precoVenda*quantidade) AS total FROM orcamentos_itens WHERE fkIdOrcamento =". base64_decode($_GET['ref']).") , total = (SELECT SUM(precoVenda*quantidade) AS total FROM orcamentos_itens WHERE fkIdOrcamento =". base64_decode($_GET['ref']).") WHERE pkId =". base64_decode($_GET['ref']));
...
if(isset($_POST['btnConfirmar'])){
    ...
    mysqli_query($conecta, "UPDATE orcamentos SET fkIdCliente = " . $_POST['txtCliente']. " WHERE pkId =". base64_decode($_GET['ref']));
...
if(isset($_POST['txtCodigoProduto'])){
    ...
    mysqli_query($conecta, "DELETE FROM orcamentos_itens WHERE fkIdOrcamento=".base64_decode($_GET['ref'])." AND fkIdProduto='".$_POST['txtCodigoProduto']."'");
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                    $query=mysqli_query($conecta, "SELECT A.*, B.razaoSocial AS nome, B.endereco, B.telefone, B.celular, B.email FROM orcamentos A, clientes B WHERE B.pkId=A.fkIdCliente AND A.pkId=".base64_decode($_GET['ref']));
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-body printableArea">
                            <h3><b>ORÇAMENTO</b> <span class="pull-right">#<?php echo str_pad(base64_decode($_GET['ref']), 8, 0, STR_PAD_LEFT) ?></span></h3><p>Data Orçamento : <i class="fa fa-calendar"></i> <?php echo date('d/m/Y', strtotime($result['data'])) ?></p>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                ...
                                <div class="col-md-12" style="margin-top:-50px;">
                                    <div class="table-responsive m-t-40" style="clear: both;">
                                        <button class="btn btn-info m-b-10" style="float:right" data-toggle="modal" data-target="#InsertProduto" ><i class="fas fa-plus"></i> Adicionar Produto</button>
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    $buscaProdutos=mysqli_query($conecta, "SELECT A.*, B.nome AS nomeProduto FROM orcamentos_itens A, produtos B WHERE B.pkId=A.fkIdProduto AND A.fkIdOrcamento=".base64_decode($_GET['ref']));
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right"><?php echo $resultProdutos['precoVenda'] ?></td>
                                                    <td class="text-right"><?php echo $resultProdutos['quantidade'] ?></td>
                                                    <td class="text-right"><?php echo number_format($resultProdutos['precoVenda']*$resultProdutos['quantidade'], 2) ?></td>
                                                </tr>
                                                <?php } } else { ?>
                                                <tr>
                                                    <td colspan="5">
    ...
    <div class="modal fade" id="TrocaCliente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Troca de Cliente Orçamento</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post">
                        <div class="form-group">
                            <h4 class="control-label text-justify m-b-20 m-t-20">Aqui você pode selecionar outro cliente para este orçamento, ok?</h4>
                        </div>
