...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "INSERT INTO cnae (pkId , descricao) VALUES ('" . (trim($_POST["txtCodigo"])) . "', '" . strtoupper(trim($_POST["txtNome"])) . "')");
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtCodigo" class="form-control" placeholder="Ex: 4722901" autofocus required>
                                                </div>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label class="control-label">Descrição CNAE</label>
                                                    <input type="text" name="txtNome" class="form-control" placeholder="Ex: Comercio varejista de Carnes Frescas, frigorificadas, congeladas;" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
