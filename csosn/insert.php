...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "INSERT INTO tributacaocsosn (pkId, descricao) VALUES ('" . strtoupper(trim($_POST["txtCodigo"])) . "', '" . strtoupper(trim($_POST["txtNome"])) . "')");
                                        ...
                                        <div class="row pt-3">
                                             <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtCodigo" class="form-control" placeholder="Ex: 0102" required>
                                                </div>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label class="control-label">Origem dos Produtos</label>
                                                    <input type="text" name="txtNome" class="form-control" placeholder="Ex: TRIBUTADA PELO SIMPLES NACIONAL S/PERMISSAO DE CREDITO" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
