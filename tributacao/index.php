...
if(isset($_POST['btnExcluir'])){
    $query=mysqli_query($conecta, "DELETE FROM tributacao WHERE pkId = " . $_POST['txtCodigo']) or die(mysql_error());
    if($query){
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Tributação PIS/COFINS</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Arquivo de Tributação PIS/COFINS</h4>
                                <h6 class="card-subtitle">Cadastre novas <code>Tributações PIS/COFINS </code> ou altere as informações de uma tributação PIS/COFINS <code>cadastrada</code>.</h6>
                                    ...
                                    <tbody>
                                        <?php
                                            if(isset($_POST['txtBusca'])){
                                                $busca=mysqli_query($conecta, "SELECT * FROM tributacao WHERE descricao LIKE '%". $_POST['txtBusca'] ."%' ORDER BY pkId");
                                            } else {
                                                $busca=mysqli_query($conecta, "SELECT * FROM tributacao ORDER BY pkId");
                                            }
