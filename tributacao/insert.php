...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "INSERT INTO tributacao (pkId, descricao) VALUES ('" . strtoupper(trim($_POST["txtCodigo"])) . "', '" . strtoupper(trim($_POST["txtNome"])) . "')");
                                        ...
                                        <div class="row pt-3">
                                             <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtCodigo" class="form-control" placeholder="Ex: 01" required>
                                                </div>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label class="control-label">Descrição Tributação PIS/COFINS</label>
                                                    <input type="text" name="txtNome" class="form-control" placeholder="Ex: OPERACAO TRIBUTAVEL COM ALIQUOTA BASICA" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
