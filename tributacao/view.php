...
if(isset($_POST['btnEnviar'])){
    ...
    $query = mysqli_query($conecta, "UPDATE tributacao SET descricao = '" . strtoupper(trim($_POST["txtNome"])) . "' WHERE pkId = " . base64_decode($_GET['ref']));
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Tributação PIS/COFINS</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../">Home</a></li>
                                    <li class="breadcrumb-item"><a href=".">Tributação PIS/COFINS</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <?php
                                $query=mysqli_query($conecta, "SELECT * FROM tributacao  WHERE pkId=".base64_decode($_GET['ref']));
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label">Codigo PIS/COFINS</label>
                                                    <input type="text" name="txtNome" class="form-control" value="<?php echo $result['pkId'] ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label class="control-label">Descricão Tributação PIC/COFINS</label>
                                                    <input type="text" name="txtNome" class="form-control" value="<?php echo $result['descricao'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
