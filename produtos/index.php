...
if(isset($_POST['btnExcluir'])){
    $query=mysqli_query($conecta, "DELETE FROM produtos WHERE pkId = " . $_POST['txtCodigo']) or die(mysql_error());
    if($query){
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Arquivo de Produtos</h4>
                                <h6 class="card-subtitle">Cadastre novos <code>Produtos </code> ou altere as informações de um Produto <code>cadastrado</code>.</h6>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="text-align: right; padding-right: 25px">Estoque</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            if(isset($_POST['txtBusca'])){
                                                $busca=mysqli_query($conecta, "SELECT * FROM produtos WHERE nome LIKE '%". $_POST['txtBusca'] ."%' ORDER BY pkId");
                                            } else {
                                                $busca=mysqli_query($conecta, "SELECT * FROM produtos ORDER BY pkId");
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right"><?php echo $result['precoVenda'] ?></td>
                                            <td style="text-align: right; padding-right: 25px"><?php echo $result['estoqueAtual'] ?></td>
                                        </tr>
                                        <?php }} else { ?>
                                        <tr>
                                            <td colspan="3">
